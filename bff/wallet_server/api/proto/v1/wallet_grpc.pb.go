...
type WalletServiceClient interface {
	GetBalance(ctx context.Context, in *GetUserBalanceRequest, opts ...grpc.CallOption) (*UserBalanceResponse, error)
}
...
func (c *walletServiceClient) GetBalance(ctx context.Context, in *GetUserBalanceRequest, opts ...grpc.CallOption) (*UserBalanceResponse, error) {
...
type WalletServiceServer interface {
	GetBalance(context.Context, *GetUserBalanceRequest) (*UserBalanceResponse, error)
...
func (UnimplementedWalletServiceServer) GetBalance(context.Context, *GetUserBalanceRequest) (*UserBalanceResponse, error) {
...
func _WalletService_GetBalance_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletServiceServer).GetBalance(ctx, req.(*GetUserBalanceRequest))
	}
...
var WalletService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "api/proto/v1/wallet.proto",
}
