...
type EventPublisher interface {
	PasswordForgotEvent(ctx context.Context, event domain.Event) error
}
...
func NewAuthService(repo AuthRepository, jwtRepo JwtRepository, eventPublisher EventPublisher) *AuthService {
	return &AuthService{repo: repo, jwtRepo: jwtRepo, eventPublisher: eventPublisher}
}
